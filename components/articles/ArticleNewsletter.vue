<template>
  <section class="bg-srblue py-24" id="newsletter">
    <div class="px-5 max-w-2xl m-auto">
      ...
      <div class="max-w-4xl pt-6 m-auto">
        <style type="text/css">
        ...
        .embed-form-super-wrapper {
          ...
          border-color: rgba(186, 186, 186, 0.02) !important;
        ...
        .embed-form-super-wrapper .hs-form input[type=submit] {
          ...
          border-radius: 0px !important;
          border-style: solid !important;
          border-color: rgba(249, 250, 250, 0) !important;
          border-radius: 0px !important;
          -moz-border-radius: 0px !important;
          -webkit-border-radius: 0px !important;
          box-sizing: border-box;
        ...
        .embed-form-super-wrapper .hs-form input[type=submit]:hover {
          background: #afbaf5 !important;
          color: #ffffff !important;
          border-color: rgba(83, 184, 251, 0.04) !important;
        }
        ...
        </style><script charset="utf-8" type="text/javascript" src="//js.hsforms.net/forms/v2.js"></script><script>hbspt.forms.create( {
          target: ".Belch-fHOWvZT6aqo8TYbTi6FA", portalId: "25028945", formId: "ba72938e-1259-4322-ace9-3db028331e78", css: ""
        }

      );
      </script><div class="embed-form-super-wrapper Belch-fHOWvZT6aqo8TYbTi6FA"></div>
      </div>
    </div>
